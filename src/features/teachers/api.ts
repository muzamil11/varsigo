...
/** Flags a review for moderator attention. Anyone can call this (no login
 *  check here beyond what the caller enforces), matching the review/upload
 *  submission flow's existing trust model — see supabase/schema.sql. */
...
/** Inserts with approved: false — the suggestion appears in Admin →
