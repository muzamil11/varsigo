...
/** Admin-curated external resources shown on Home's "Important Links"
 *  section — plain static list, no backend/DB needed since these rarely
 *  change. Add new entries here as they come in. */
